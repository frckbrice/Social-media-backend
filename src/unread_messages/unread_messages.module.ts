...
import { UnreadMessage, UnreadMessageSchema } from './schema/unread_messages.schema';
import { MongooseModule } from '@nestjs/mongoose';

@Module({
  imports: [
    MongooseModule.forFeature([{name: UnreadMessage.name, schema: UnreadMessageSchema}])
  ],
